...
class RestaurantServiceTest {
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object() throws restaurantNotFoundException {
        ...
        Restaurant findRestaurantByName = service.findRestaurantByName("Amelie");
        service.findRestaurantByName("Amelie");
        assertEquals(null,service.findRestaurantByName("Amelie"));
    }
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        ...
        String findRestaurantByName = service.findRestaurantByName().name();
